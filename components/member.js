...
export default function Member() {
  ...
  return (
    ...
    <section className="mt-16 mb-16 md:mb-12">
      ...
      <ul className="gap-4 grid md:grid-cols-2 pt-4">
          {/* TODO: component化する */}
          {memberInfos.map((item) => (
            <li className="flex flex-col bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <img className="object-cover w-full h-80 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src={item.profileImage} alt={item.name} />
                ...
                <ul className="flex gap-3 justify-end">
                  {
                    item.instagram && (
                      <li>
                        <a href={item.instagram} target="_blank" noopener noreferer>
                  ...
                  }
                  {
                    item.twitter && (
                      <li>
                        <a href={item.twitter} target="_blank" noopener noreferer>
                  ...
                  }
                  {
                    item.tiktok && (
                      <li>
                        <a href={item.tiktok} target="_blank" noopener noreferer>
                          <FaTiktok size={20} />
                        </a>
                      </li>
                    )
                  }
                  {
                    item.externalLink && (
                      <li>
                        <a href={item.externalLink} target="_blank" noopener noreferer>
