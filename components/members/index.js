  ...
  const memberInfos = [
    {
      ...
      description:
        "2018年に慶應義塾大学経済学部を卒業後、楽天グループ株式会社で企業のEC事業展開のコンサルティングに従事。同時に2016年よりストリートダンスクルーENcounter ENgraversにて全体統括として、イベントや公演の企画、組織マネジメントを担う。2022年5月にENcounterENgraversのメンバー4名と共にENEN,Inc.を設立。プロジェクトマネジメントやマーケティング戦略の立案の経験を元に、各事業の旗振りを行う。",
    ...
    },
    {
      ...
      description:
        "全国に100名以上メンバーが在籍する、HIPHOPダンスチームENcounter ENgraversを主宰する振付師兼ストリートダンサー。17歳で、高校生全国ストリートダンス大会で優勝し、その後、日本最大級の振付作品コンテスト『Legend Tokyo』にて、史上初の審査員満場一致の完全優勝を成し遂げる。振付師としては、『ロミオ＆ジュリエット』『NEWSIES』『17AGAIN』『宝塚歌劇団』をはじめとしたミュージカルからアーティストの振付まで多岐にわたり活動し、22-23 SEASONよりプロダンスリーグD.LEAGUEにてSEPTENI RAPTURESのディレクターに就任。",
    ...
    },
    {
      ...
      position: "CopyWriter",
      description:
        "2016年に慶應義塾大学卒業後、広告代理店で6年間勤務し、2022年4月よりGEKIに参画。ブランドと社会の接触面を最大化させるPR視点でのブランドプロポジションやアクションプランを設計し、クリエイティブによる視覚言語でのアウトプットまで行う。ブランドの性格やあるべき姿を汲み取り、血の通ったコピーを起点にブランドを作っていくことを強みとしている。",
    ...
    },
    {
      ...
      description:
        "2017年愛知大学文学部メディア芸術専攻卒業。現在は個人事業主として、webapp開発・プロジェクトに参画し、さまざまなアプリケーションを開発している。",
    ...
    },
    {
      ...
      description:
        "熊本県出身。2017年名古屋大学卒業。広告会社に入社後、宇宙・アニメ・食品・衣料・車など幅広い業界のアクティベーションイベントやキャンペーンのディレクション・プロデュースに従事。ストリートダンスクルー ENcounter ENgraversでは、イベントオーガナイザーとして、東京芸術劇場や渋谷WOMBでのダンスイベントの全体プロデュースを担当。自分自身のひとりの生活者としての感覚を大切にし、常に「これに触れた人はどう感じるか？」を想像することを第一としている。",
    ...
    <section className="mt-32 mb-16 md:mb-12">
      ...
      <ul className="gap-4 grid lg:grid-cols-2 pt-4">
        ...
        {memberInfos.map((item) => (
          <li
            key={item.name}
            className="flex flex-col bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
            <Image
